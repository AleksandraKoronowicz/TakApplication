...
public class actStudentLogin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_student_login);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_act_student_login, menu);
        return true;
    }
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            switch (position) {
                case 0:
                    actStudentLoginMain loginMain = new actStudentLoginMain();
                    return loginMain;
                case 1:
                    actStudentLoginCode logiCode = new actStudentLoginCode();
                    return logiCode;
                case 2:
                    actStudentLoginDetails loginDetails = new actStudentLoginDetails();
                    return loginDetails;
                default:
                    return  null;
            }
